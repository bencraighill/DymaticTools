...
namespace DymaticToolsVSIX
{
	...
	[ProvideOptionPage(typeof(DymaticToolsGeneralOptions), "Dymatic Tools", "General", 0, 0, true)]
	...
	public sealed class DymaticToolsPackage : AsyncPackage
	{
		/// <summary>
		...
		public static DymaticToolsPackage Instance { get; private set; }

		public DymaticToolsPackage()
		{
			Instance = this;
		}

		internal DymaticSolutionEventsListener SolutionEventsListener { get; private set; }
		internal DymaticToolsGeneralOptions GeneralOptions => GetDialogPage(typeof(DymaticToolsGeneralOptions)) as DymaticToolsGeneralOptions;
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
			...
			await AttachDymaticEditorCommand.InitializeAsync(this);

			SolutionEventsListener = new DymaticSolutionEventsListener(this);
		}
